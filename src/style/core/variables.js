...
export const DimensionScale = 2;
export const DimensionXs = 4;
export const DimensionSm = 8;
export const DimensionMd = 16;
export const DimensionLg = 32;
export const DimensionXl = 64;
...
export const SpacingMultiValue = "8 64";
...
export const LineHeightsHeading = "120%";
